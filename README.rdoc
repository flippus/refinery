...
If you want to add a js file for only the backend of your app, you can also register the file in +refinery_directory/config/initializers/core.rb+ with the following command:
...
To to use the form generator you need this command:

  rails generate refinery:form form_name (attribute:attribut_type)*x --extension extension_name --namespace namespace_name

If you want to see some information. just invoke +rails generate refinery:form+.
